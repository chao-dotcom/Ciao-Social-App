...
const Profile = () => {
  ...
  // `loadProfile` and `loadArticles` were previously declared but
  // became unused after combining loading into the effect above.
  // They were removed to avoid ESLint `no-unused-vars` warnings.
